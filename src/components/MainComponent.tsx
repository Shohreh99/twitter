              ...
              >
                ...
                <div className="flex flex-col">
                  <div className="flex item-center space-x-1">
                    <div>
                    <div className="font-bold">Soroosh sse</div>
                    <div className="text-gray-500">@sorooshssecom</div>
                    ...
                    <div className="text-white text-base">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, saepe maiores unde veniam culpa itaque enim
                      voluptatibus molestias voluptates minima ut. Explicabo, laborum magnam molestiae suscipit corrupti vel 
                      omnis ipsa, eaque soluta tempora quas! Enim, deserunt suscipit, voluptatum magni nostrum porro quam.
                    </div>
                    <div className="bg-slate-400 aspect-square w-full h-96 rounded-xl mt-2">
                    </div>
                    <div className="flex item-center justify-start space-x-20 mt-2 w-full">
