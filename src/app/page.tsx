            ...
            <div>
              <div className="relative w-full h-full group">  
                 <input
                   ...
                   className=" outline-none  peer focus:border-primary focus:border bg-neutral-900/90 border-none w-full h-full rounded-xl py-4 px-8"
                 />
                 <label
                   htmlFor="searchBox" 
                ...
                {Array.from({length:5}).map((_,i)=>(
                 ...
                 <div className="w-10 h-10 bg-neutral-600 rounded-full flex-none"></div>
                  <div className="flex flex-col">
                    ...
                    <div className="text-gray-500 text-xs">@otheruser1232
                    </div>
                  </div>
                 </div>
